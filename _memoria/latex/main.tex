...
\begin{document}
    % show everything on biblio
    \nocite{*}

    % LOAD FIRST PAGE & DEDICATION
    \input{./sections/00/01_titlePage}
    \input{./sections/00/02_dedication}
    ...
    \input{./sections/10/_webApp}
    \input{./sections/11/_functionalities}
